...
<div class="card">
    <div class="card-header">
        {{ trans('global.edit') }} {{ trans('cruds.waanoo.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.waanoos.update", [$waanoo->id]) }}" enctype="multipart/form-data">
            @method('PUT')
            @csrf
            <div class="form-group">
                ...
                <select class="form-control {{ $errors->has('island') ? 'is-invalid' : '' }}" name="island" id="island" required>
                    ...
                    @foreach(App\Models\Waanoo::ISLAND_SELECT as $key => $label)
                        <option value="{{ $key }}" {{ old('island', $waanoo->island) === (string) $key ? 'selected' : '' }}>{{ $label }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('no') ? 'is-invalid' : '' }}" type="number" name="no" id="no" value="{{ old('no', $waanoo->no) }}" step="1" required>
                @if($errors->has('no'))
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('village') ? 'is-invalid' : '' }}" type="text" name="village" id="village" value="{{ old('village', $waanoo->village) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('recipient') ? 'is-invalid' : '' }}" type="text" name="recipient" id="recipient" value="{{ old('recipient', $waanoo->recipient) }}" required>
            ...
            <div class="form-group">
                ...
                @foreach(App\Models\Waanoo::STATUS_RADIO as $key => $label)
                    <div class="form-check {{ $errors->has('status') ? 'is-invalid' : '' }}">
                        <input class="form-check-input" type="radio" id="status_{{ $key }}" name="status" value="{{ $key }}" {{ old('status', $waanoo->status) === (string) $key ? 'checked' : '' }} required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('expenditure_per_trip') ? 'is-invalid' : '' }}" type="number" name="expenditure_per_trip" id="expenditure_per_trip" value="{{ old('expenditure_per_trip', $waanoo->expenditure_per_trip) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('hire_num') ? 'is-invalid' : '' }}" type="number" name="hire_num" id="hire_num" value="{{ old('hire_num', $waanoo->hire_num) }}" step="1" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('catch_weight') ? 'is-invalid' : '' }}" type="text" name="catch_weight" id="catch_weight" value="{{ old('catch_weight', $waanoo->catch_weight) }}" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('total_catchval') ? 'is-invalid' : '' }}" type="number" name="total_catchval" id="total_catchval" value="{{ old('total_catchval', $waanoo->total_catchval) }}" step="0.01" required>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('comments') ? 'is-invalid' : '' }}" type="text" name="comments" id="comments" value="{{ old('comments', $waanoo->comments) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('remarks') ? 'is-invalid' : '' }}" name="remarks" id="remarks" required>{{ old('remarks', $waanoo->remarks) }}</textarea>
